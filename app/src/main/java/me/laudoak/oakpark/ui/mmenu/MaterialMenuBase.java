...
package me.laudoak.oakpark.ui.mmenu;
...
public abstract class MaterialMenuBase implements MaterialMenu
{
    ...
    /**
     * Call from {@link Activity#onSaveInstanceState(Bundle)} to store current icon state
     *
    ...
    /**
     * Call from {@link Activity#onPostCreate(Bundle)} to restore icon state
     *
     * @param state state
     */
