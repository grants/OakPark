package me.laudoak.oakpark.ui.seplv;
...
public class SeparateListView extends ListView{
	...
	public SeparateListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.SeparateListView);
		separateAll = t.getBoolean(R.styleable.SeparateListView_separate_all, false);
		showDownAnim = t.getBoolean(R.styleable.SeparateListView_showDownAnim, true);
		t.recycle();
		init();
	}

	public SeparateListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public SeparateListView(Context context) {
		super(context);
		init();
	}
