package me.laudoak.oakpark.ui.swbutton;
...
/**
 * Created by LaudOak on 2015-11-23 at 22:32.
 */
public class SwitchButton
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        int[] size = getViewSizeFromSpec(this, widthMeasureSpec, heightMeasureSpec);
        int width = size[0];
        int height = size[1];
    ...
    private int[] getViewSizeFromSpec(View view, int widthSpec, int heightSpec)
    {
