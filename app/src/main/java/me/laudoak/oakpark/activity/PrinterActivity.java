        ...
        FontPickerFragment.CallBack
{
    ...
    {
        hideCursor();
        Bitmap bm = dampEditor.getThisBitmap();
        showCursor();

        new LocalShare().share(FileUtil.saveImageToExternalStorage(this,uuid,bm),title.getText().toString(),this);
    }

    private void doSave()
    {
        hideCursor();
        String fileName = FileUtil.saveImageToExternalStorage(this,uuid,dampEditor.getThisBitmap());
