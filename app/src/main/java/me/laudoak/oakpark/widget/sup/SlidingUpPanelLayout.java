package me.laudoak.oakpark.widget.sup;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.bg_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.bg_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
