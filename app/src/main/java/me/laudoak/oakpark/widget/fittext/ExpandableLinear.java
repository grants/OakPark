...
package me.laudoak.oakpark.widget.fittext;
 ...
 */
public class ExpandableLinear extends LinearLayout implements View.OnClickListener{
    ...
    public ExpandableLinear(Context context) {
        this(context, null);
    }

    public ExpandableLinear(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ExpandableLinear(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ExpandableLinear);
