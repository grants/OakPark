 ...
 */
public class VersePush extends XBasePush {

    private static final String TAG = "VersePush";

    private VersePush(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public VersePush build()
        {
            return new VersePush(this);
        }
